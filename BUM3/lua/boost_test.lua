...
-- CONFIG
	...
	show_boost_level = false -- show stuff on console
	...
	FLYING_VEHICLES = {
		["vehicles\\banshee\\banshee_mp"] = 0.022,
	}
--CONFIG
...
function OnPlayerConnect(PlayerIndex)
    local pi=tonumber(PlayerIndex)
    WITH_FLAG[pi]=0
end

function OnDeath(PlayerIndex,Causer)
    local pi=tonumber(PlayerIndex)
    WITH_FLAG[pi]=0
end
